...
class CrispyFishEventRegistrationIT {

    @Test
    fun itShouldQueryThscc2016Points1Registrations() {
        val actual = Events.Thscc2016Points1Danville.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2016Points2Registrations() {
        val actual = Events.Thscc2016Points2Cary.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2016Points3Registrations() {
        val actual = Events.Thscc2016Points3Danville.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2016Points9Registration() {
        val actual = Events.Thscc2016Points9Cary.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2017Points1Registrations() {
        val actual = Events.Thscc2017Points1Danville.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2017Points5Registrations() {
        val actual = Events.Thscc2017Points5CaryTowneCenter.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2017Points9Registrations() {
        val actual = Events.Thscc2017Points9Danville.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2018Points1Registrations() {
        val actual = Events.Thscc2018Points1Danville.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2018JustForFunRegistrations() {
        val actual = Events.Thscc2018JustForFunCary.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2018WeddingcrossRegistrations() {
        val actual = Events.Thscc2018WeddingcrossDanville.queryAllRegistrations()
    ...
    fun itShouldQueryThscc2018Points8Registrations() {
        val actual = Events.Thscc2018Points8Cary.queryAllRegistrations()
    ...
    fun `It should query all registrations even those having raw time but lacking raw position`() {
        val actual = Events.Issue42.queryAllRegistrations()
